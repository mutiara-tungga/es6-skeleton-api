...
def.host = 'localhost';
def.port = 4000;
def.baseurl = `http://${def.host}:${def.port}`;
...
def.knex.connection.database = 'es6-skeleton';
...
def.apiKeyPostmarkapp = '61948b71-3cd3-42a5-aedb-5a3aca8d1053';
def.postmarkappServiceSender = 'no-reply@skyshi.com';
